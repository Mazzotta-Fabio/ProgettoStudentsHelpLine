...
public class ImpGestioneInterazioneTutorStudenteTest extends TestCase {
	...
	public void test1InserisciDomanda() {
		...
		gestioneInterazione.inserisciDomanda("OGGETTO","TESTO","URL", "fabio.mazzotta@unisa.it", "antonio.cimino@studenti.unisa.it");
		gestioneInterazione.inserisciDomanda("OGGETTO 1", "TESTO 1", "URL 2", "francesco.verdi@unisa.it", "antonio.derita@studenti.unisa.it");
		List<String> domande1 = gestDom.recuperaDomandeSenzaRisposta("antonio.cimino@studenti.unisa.it");
		List<String> domande2 = gestDom.recuperaDomandeSenzaRisposta("antonio.derita@studenti.unisa.it");
	...
	public void test4VisualizzaAccount() {
		Tutor tutor=new Tutor("Fabio","Mazzotta","fabio.mazzotta@unisa.it","3452128996","/home/xyz","3452128996","matematica","86","Laurea Triennale");
	...
	public void test0DomandeDaVisualizzare() {
		boolean notifica = gestioneInterazione.domandeDaVisualizzare("antonio.derita@studenti.unisa.it", "Studente");
		assertEquals(false,notifica);
		notifica = gestioneInterazione.domandeDaVisualizzare("ines.votta@studenti.unisa.it", "Studente");
