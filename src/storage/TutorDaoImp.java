...
public class TutorDaoImp implements ObjectDao {
  ...
  public void inserisciDati(Object o) throws SQLException {
    Tutor t = (Tutor) o;
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("insert into tutor "
        + "(Email,"
        + "Pass,"
  ...
  public boolean recuperaDati(Object o) throws SQLException {
    ...
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("select * from tutor "
        + "where Email = ?;");
    prepared.setString(1, t.getEmail());
   ...
   * @return una lista di oggetti di tipo Tutor con tutte le informazioni reperite su 
  ...
  /**
   * Il metodo serve per modificare le informazioni di un Tutor nel DataBase.
  ...
  public void modificaDati(Object o) throws SQLException {
    Tutor t = (Tutor) o;
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("update tutor "
          + "set Pass=? ,"
          + "Immagine=?, TitoloDiStudio=?, MateriaDiCompetenza=?, Nome=?,Cognome=?, "
          + "VotoDiLaurea=?,"
