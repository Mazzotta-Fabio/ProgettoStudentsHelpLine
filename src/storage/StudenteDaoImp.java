 ...
 * Questa classe permette di aggiungere, reperire e eliminare informazioni 
 per gli Studenti su DataBase.
...
public class StudenteDaoImp implements ObjectDao {
  ...
  public void inserisciDati(Object o) throws SQLException {
    ...
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("insert into studente("
        + "Email,Pass,"
   ...
   * @param: o l'oggetto contenente le informazione dello Studente.
   * @return true se lo Studente è presente sul DataBase, e la password corrisponde, 
   altrimenti false.
   * @throws: SQLException 
   */
  @Override
  public boolean recuperaDati(Object o) throws SQLException {
    ...
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("select * from studente "
        + "where Email = ?;");
    prepared.setString(1, s.getEmail());
   ...
   * @return una lista di oggetti di tipo Studente con tutte le informazioni reperite su 
   DataBase per ognuna di essi.
   * @throws: SQLException 
   */
  @Override
  ...
  public void modificaDati(Object o) throws SQLException {
    Studente s = (Studente) o;
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("update studente set "
        + "Pass "
        + "= ?, Matricola = ?,"
