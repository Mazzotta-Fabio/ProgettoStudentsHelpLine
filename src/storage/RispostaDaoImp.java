 ...
 * Questa classe permette di aggiungere, reperire e eliminare informazioni per le 
 Risposte su DataBase.
...
public class RispostaDaoImp implements ObjectDao {
  ...
  public void inserisciDati(Object o) throws SQLException {
    ...
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("insert into risposta ("
        + "Contenuto,"
   ...
   * @return: una lista di oggetti di tipo Risposta con tutte le informazioni reperite 
   su DataBase per ognuna di esse.
   * @throws: SQLException 
   */
  ...
  /**
   * Il metodo serve per modificare le informazioni di una risposta nel DataBase.
  ...
  public void modificaDati(Object o) throws SQLException {
    Risposta r = (Risposta) o;
    PreparedStatement prepared = (PreparedStatement) con.prepareStatement("update risposta set "
        + "Valutazione = "
        + "? , Visualizzata = ? where IdRisposta =  ?");
