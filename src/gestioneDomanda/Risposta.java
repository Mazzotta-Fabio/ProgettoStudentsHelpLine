...
public class Risposta {
	...
	public Risposta(int id,String testo, String allegato,String valutazione,String visualizzazione) {
		this.testo = testo;
	...
	/**
	 * Il metodo  restituisce se la risposta è stata visualizzata
	 * @return visualizzazione di una risposta
	 */
	...
	/**
	 * Il metodo consente di inserire la visualizzazione della risposta
	 * @param visualizzazione: visita della risposta
	 */
