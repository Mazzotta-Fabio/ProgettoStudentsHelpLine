...
<font color="white" style="margin-left:32%"><strong>VISUALIZZA DOMANDE RISPOSTE</strong><span style="margin-left:34%"><a  href="Logout"><img src="img/logout.png" style="width:50px;height:50px;align:right;"></img></a></span></font></p>
</header>
<body>
<section id="main">
<div class="container">
