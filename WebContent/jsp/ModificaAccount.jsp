...
<input type="text" name="cogn"id="p"><br><br>
<font color="black"><strong>Email:</strong></font><br><br>
<input type="text" name="ema"id="u"><br><br>
<font color="black"><strong>Password:</strong></font><br><br>
<input type="text" name="pass"id="u"><br><br>
...
<input type="text" name="cell"id="u"><br><br>
<font color="black"><strong>Voto laurea:</strong></font><br><br>
<input type="text" name="voto"id="u"><br><br>
...
<font face="sans-serif">
<font color="black"><strong>Nome:</strong></font><br><br>
<input type="text" name="nome"id="u"><br><br>
 <font color="black"><strong>Cognome:</strong></font><br><br>
<input type="text" name="cognome"id="p"><br><br>
<font color="black"><strong>Email:</strong></font><br><br>
<input type="text" name="email"id="u"><br><br>
<font color="black"><strong>Password:</strong></font><br><br>
<input type="text" name="password"id="u"><br><br>
<font color="black"><strong>Matricola:</strong></font><br><br>
<input type="text" name="matricola"id="u"><br><br>
