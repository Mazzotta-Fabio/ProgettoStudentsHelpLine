...
<input type="file" name="immagine" value="<%=request.getAttribute("Immagine") %>" id="immagineT" onchange="myFunction10()" enable><br><br><span id="par10"></span> <input type="hidden" name ="url" id="path" value="<%=request.getAttribute("Immagine") %>"><br><br>
...
<script>
	...
	function myFunctionT() {
		...
		var f4 = document.getElementById("par4").innerHTML.length;
		var f6 = document.getElementById("par6").innerHTML.length;
		var f7 = document.getElementById("par7").innerHTML.length;
		var f8 = document.getElementById("par8").innerHTML.length;
		var f9 = document.getElementById("par9").innerHTML.length;
		var f10 = document.getElementById("par10").innerHTML.length;
		...
		if(f3>0 || f4>0  || f6>0 || f7>0 ||f8>0 ||f9>0 || f10>0){document.getElementById("regS").disabled = true;}
		else {document.getElementById("regT").disabled = false;}
	}


	function myFunctionS() {
		var f3 = document.getElementById("par11").innerHTML.length;
		var f4 = document.getElementById("par12").innerHTML.length;
		var f6 = document.getElementById("par14").innerHTML.length;
		var f7 = document.getElementById("par15").innerHTML.length;
		var f8 = document.getElementById("par16").innerHTML.length;
		var f9 = document.getElementById("par17").innerHTML.length;
		...
		if(f3>0 || f4>0 || f6>0 || f7>0 ||f8>0 ||f9>0){document.getElementById("regS").disabled = true;}
		else {document.getElementById("regT").disabled = false;}
	}
</script>
</body>
