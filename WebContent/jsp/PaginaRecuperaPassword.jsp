...
<form method="get" action="RecuperaEmail.html" name="modulo">
<p align="center">
<input type="radio" name="tipoUtente" id="myCheck1"> TUTOR  <input type="radio" name="tipoUtente" id="myCheck2" checked> STUDENTE <br><br>
 ...
 <p align="center"><input type="button" value="INVIA" id="login" name="button" onclick="myFunction()"><br><br>
