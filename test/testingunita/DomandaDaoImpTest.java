...
public class DomandaDaoImpTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    Tutor tutor = new Tutor("Mario","Rossi","fabio.mazzotta@unisa.it","12345678","/home/xyz",
        "1234567891","matematica","86","Laurea Triennale");
    Tutor tutor2 = new Tutor("Ezechiele","Nuvola","federico.coiro@unisa.it","1234567845","/ho/xy/o",
        "1234567891","progrmmazione 2","108","Dottorato di ricerca");
    Studente studente = new Studente("Rosa","Marini","antonio.derita@studenti.unisa.it","12345678",
        "/home/xyz","0522500518","2");
    Studente studente2 = new Studente("Chiara","Giani","ines.votta@studenti.unisa.it","123456err",
        "/home/xyz/o","0512102515","1");
